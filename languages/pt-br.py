...
'Cadastro Usuarios': 'Cadastro Usuarios',
...
'Mapeia TIC': 'Mapeia TIC',
'Mapeia TIC - v0.1b': 'Mapeia TIC - v0.1b',
...
'Password': 'Senha',
"Password fields don't match": 'Campos Password não coincidem',
'Perfil': 'Perfil',
'Plugins': 'Plugins',
...
'Selecione para deletar': 'Selecione para deletar',
'Semantic': 'Semantic',
'Services': 'Services',
'Sistema de Mapeamento das TICs nas Escolas': 'Sistema de Mapeamento das TICs nas Escolas',
'Sobre': 'Sobre',
...
'is_choose': 'Escolha seu perfil',
'is_email': 'Informe um email válido',
'is_empty': 'Esse campo é de preenchimento obrigatório',
'located in the file': 'located in the file',
'login': 'Entrar',
'login_already': 'Você já está logado!',
'logout': 'Sair',
'lost password?': 'lost password?',
'new record inserted': 'novo registro inserido',
'next 100 rows': 'próximas 100 linhas',
'or import from csv file': 'ou importar de um arquivo csv',
'out_lab': 'Informe um valor entre 1 e 100',
'out_range': 'Informe um valor válido',
'password': 'password',
