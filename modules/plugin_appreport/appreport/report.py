...
class Report():
    ...
    def __init__(self, user_name = 'MapTIC', title = 'Report', orientation = 'P', unit = 'mm', format = 'A4'):
        """ Orientation: 'P' for portrait (retrato) or 'L' for landscape (paisagem)
        """
        self.user_name = user_name if user_name is not None and user_name.strip() != '' else 'MapTIC'
        self.title = title
...
class ReportHtml(Report):
    ...
    def __init__(self, html, user_name = 'MapTIC', title = 'Report',
...
class ReportHtmlDb(ReportHtml):
    ...
    def __init__(self, db, table, filter = '', user_name = 'MapTIC', title = 'Report',
        orientation = 'P', unit = 'mm', format = 'A4', charset = 'utf-8'):
...
class ReportHtmlDbWeb2py(ReportHtmlDb):
    ...
    def __init__(self, table, filter = '', user_name = 'MapTIC', title = 'Report', orientation = 'P', unit = 'mm', format = 'A4', charset = 'utf-8'):
